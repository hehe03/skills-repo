...
FIXED_FEATURE_NAMES = [
    ...
    "behavior_action_switch_ratio",
    "behavior_tool_like_action_count",
    "behavior_tool_like_action_ratio",
    ...
    "schema_top_level_key_count",
    "schema_leaf_field_count",
    "schema_unique_leaf_path_count",
...
FEATURE_DESCRIPTIONS = {
    "fixed_features": {
        ...
        "behavior_*": "Behavior sequence features such as action switches, repeated results, retry signals, and per-step errors.",
        "schema_*": "Schema profile features such as leaf path counts, nesting depth, list/object counts, and empty scalar ratios.",
    },
    "dynamic_field_features": {
        ...
        "field_empty_count:<path>": "Number of empty values found at this path.",
        "field_text_chars:<path>": "Total text length found at this path.",
        "field_text_max_chars:<path>": "Maximum single value text length at this path.",
        "field_unique_value_count:<path>": "Number of distinct stringified values at this path.",
        "field_unique_value_ratio:<path>": "Distinct value count divided by value count at this path.",
        "field_error_text_count:<path>": "Number of values at this path containing generic error terms.",
        ...
        "field_number_range:<path>": "Maximum minus minimum numeric value for this path.",
        "field_number_zero_ratio:<path>": "Zero ratio for numeric values at this path.",
        "field_number_positive_ratio:<path>": "Positive value ratio for numeric values at this path.",
        "field_bool_true_ratio:<path>": "True ratio for this path when all values are boolean.",
        "field_bool_false_ratio:<path>": "False ratio for this path when all values are boolean.",
    },
}
